...
{
    Serial.write("=== HID report via Bluefruit ===> ");
}
...
BluefruitHost::BluefruitHost(HardwareSerial *serial)
{
    _hw_serial = serial;
}

void BluefruitHost::init()
{
#ifdef BLUEFRUIT_TRACE_SERIAL
    Serial.write("Initializing serial to Bluefruit\n");
#endif
